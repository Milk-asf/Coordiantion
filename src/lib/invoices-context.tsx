...
interface InvoicesContextValue {
  ...
  markInvoiceSent: (id: string, params: { sentTo: string; deliveryMethod?: InvoiceDeliveryMethod }) => Promise<void>
  markInvoiceSendError: (id: string, error: string) => Promise<void>
  deleteInvoice: (id: string) => Promise<void>
  voidInvoice: (id: string) => Promise<void>
  createCreditNote: (invoice: Invoice) => Promise<Invoice | null>
  exportInvoiceToCsv: (invoice: Invoice) => void
  exportAllToCsv: (invoiceList: Invoice[]) => void
...
export function InvoicesProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const channelName = `invoices-${activeWorkspace.id}`
