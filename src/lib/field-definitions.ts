...
export const defaultStaffFields: FieldDefinition[] = [
  ...
  { id: "s-ndis-screening-number", name: "NDIS screening number", type: "text", description: "Worker NDIS screening check number", editableBy: "anyone", isSystem: false, isEnabled: true, isCustom: false, entity: "staff" },
  { id: "s-ndis-screening-expiry", name: "NDIS screening expiry", type: "date", description: "Worker NDIS screening expiry date", editableBy: "anyone", isSystem: false, isEnabled: true, isCustom: false, entity: "staff" },
...
export const staffFieldToColumnKey: Record<string, string> = {
  ...
  "s-ndis-screening-number": "ndisScreeningNumber",
  "s-ndis-screening-expiry": "ndisScreeningExpiry",
