    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-folk-surface">
        <div className="w-full max-w-[380px] px-[16px] text-center">
          ...
          <h1 className="text-[20px] font-semibold text-folk-text">Check your email</h1>
          <p className="mt-[8px] text-[13px] font-medium text-folk-secondary">
            We sent a password reset link to <span className="text-folk-text">{email}</span>. Click the link in the email to reset your password.
          </p>
          <Link
            href="/login"
            className="mt-[24px] inline-block text-[13px] font-medium text-folk-text underline underline-offset-2 transition-colors hover:text-[#555]"
          >
            Back to sign in
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-folk-surface">
      <div className="w-full max-w-[380px] px-[16px]">
        <div className="mb-[32px] text-center">
          ...
          <h1 className="text-[20px] font-semibold text-folk-text">Reset your password</h1>
