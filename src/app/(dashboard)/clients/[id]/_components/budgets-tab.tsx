              ...
              [...budgets].reverse().map((budget) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="h-[44px] whitespace-nowrap border-b border-r border-[#dcdcdc] bg-[#fafafa] px-[20px]"><UsageBar percent={usagePct} tooltip={`$${used.toLocaleString()} of $${total.toLocaleString()} used`} /></td>
