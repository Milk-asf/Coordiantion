  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#fafafa]">
      ...
      <main className="flex flex-1 items-start justify-center px-[24px] pb-[40px]">
        <div className="w-full max-w-[1040px] overflow-hidden rounded-[14px] border border-[#e2e2e2] bg-white shadow-[0_1px_3px_rgba(0,0,0,0.03)]">
            ...
            <section className="flex flex-col gap-[24px] px-[40px] py-[40px]">
              <div className="flex items-center justify-between">
                {prev ? (
                  <Link
                    href={prev.route}
                    className="flex h-[28px] w-[28px] items-center justify-center rounded-full text-[#888] transition-colors hover:bg-[#f3f3f3] hover:text-[#262626]"
              ...
              <div>
                <h1 className="text-[22px] font-semibold leading-tight text-[#262626]">{title}</h1>
              </div>

              {children}
            </section>

            <aside className="hidden bg-[#fafafa] lg:flex">
