export const inputClass =
  "h-[42px] w-full rounded-none border border-folk-border bg-folk-surface px-[14px] text-[13px] text-folk-text outline-none transition-colors placeholder:text-folk-text-placeholder focus:border-folk-secondary focus:ring-2 focus:ring-folk-subtle/50"
